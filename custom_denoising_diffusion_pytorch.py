'''
Credit for these utilities goes to 'lucidrains'. I've made small tweaks for my purposes.
You can find the original 'denoising_diffusion_pytorch.py' on their github:
...
class Trainer(object):
    def __init__(
        ...
        *,
        ...
        if folder is None:
            assert dataset is not None, 'A Dataset object must be provided if not using data from a folder'
            self.ds = dataset
        else:
